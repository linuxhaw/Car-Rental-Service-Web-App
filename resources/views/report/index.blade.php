            ...
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <ol class="breadcrumb bg-dark text-yellow-all">
                        <li class="breadcrumb-item"><a href="/backend/dashboard"><i class="fas fa-tachometer-alt"></i> Home</a>
                        </li>
                        ...
                        <div class="row"><!-- .row start -->
                            ...
                            <div class="col-md-3">
                                ...
                                <button type="button" class="form-control btn btn-primary"
                                    onclick="report_pdf_preview_with_type();">Export PDF</button>
                            ...
                            <div class="col-md-3">
                                ...
                                <button type="button" class="form-control btn btn-primary"
                                    onclick="report_pdf_export_with_type();">Preview with Pdf</button>
                            </div>
